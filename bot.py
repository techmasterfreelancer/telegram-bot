...
async def handle_text(update: Update, context):
    ...
    if step == 'whatsapp_pending':
        ...
        # ========== ORIGINAL ADMIN NOTIFICATION LOGIC (EXACT COPY) ==========
        keyboard = [
            [
...
"""
        ...
        # ========== END ORIGINAL ADMIN NOTIFICATION LOGIC ==========
        return
...
async def handle_photo(update: Update, context):
    ...
    if admin_approved == 1 and status == 'payment_pending':
        ...
        # ========== ORIGINAL ADMIN PAYMENT NOTIFICATION LOGIC ==========
        keyboard = [
            [
...
"""
        ...
        # ========== END ORIGINAL ADMIN PAYMENT NOTIFICATION LOGIC ==========
        return
